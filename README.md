...
Download the following and export the files into the directory of your choice: 
  ...
  Now that you have the needed files, fire up the powershell and run the following commands to set up the environment variables:
~~~ sh
...
~~~
  ...
  Now that we have the envirment variables we need to add them to our path with the following commands:
~~~ sh
